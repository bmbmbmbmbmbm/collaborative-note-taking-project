    ...
    if (initialValue) {
        return (
            <Form onSubmit={handleSave}>
                <div
                    className="settings"
                    style={{ backgroundColor: "white", padding: "0.3%" }}
                >
                    <Row style={{ paddingBottom: "0.5%", paddingTop: "0.5%" }}>
                        ...
                        <Col xs={1} className="d-grid gap-2">
                            <Button
                                variant={isPublic ? "warning" : "success"}
    ...
    return (
        <div {...attributes}>
            ...
            <div contentEditable={false}>
                ...
                <img className="userImage" alt="Figure" src={element.url} />
                <Button
