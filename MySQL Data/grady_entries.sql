...
CREATE TABLE `entries` (
  ...
  PRIMARY KEY (`id`),
  KEY `entries` (`user_id`),
  KEY `entries_ibfk_2` (`unit_code`),
  CONSTRAINT `entries_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `entries_ibfk_2` FOREIGN KEY (`unit_code`) REFERENCES `units` (`code`)
